...
extern ulong PRINTK_BUFFER_SIZE;

#define PRINTK_BUFFER_MAGIC     (0xFEEDBEEF)
#define PRINTK_BUFFER_SLOT_SIZE (0x00080000)
#define PRINTK_BUFFER_SLOT2_SIZE (0x00010000)
#define PHONE_HANG_LOG_SIZE     (0x00140000)
...
#define PHONE_HANG_LOG_BUFFER   ((void *)((ulong)PRINTK_BUFFER_VA + (ulong)PRINTK_BUFFER_SLOT_SIZE  + PRINTK_BUFFER_SLOT2_SIZE)) 
...
#define ASUS_WATER_ALERT "ASUS_Water_alert"
#define ASUS_OUTPUT_OVP "ASUS_BAT_OVP"
