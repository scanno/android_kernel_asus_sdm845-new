...
static irqreturn_t arm_smmu_context_fault(int irq, void *dev)
{
	...
	/*
	 * Disable client ability to map/unmap on fatal errors.
	 */
	smmu_domain->fatal_irq_pending = !non_fatal_fault;
			...
			phys_addr_t paddr, size_t size, int prot)
{
	...
	if (smmu_domain->fatal_irq_pending)
		return -EBUSY;
