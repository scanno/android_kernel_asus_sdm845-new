 ...
 * aw87319 marco
 ******************************************************************************/
#define AW87319_I2C_NAME	"AW87319_PA_RCV" 
 ...
 * aw87319 functions
 ******************************************************************************/
unsigned char aw87319_audio_receiver_rcv(void);
unsigned char aw87319_audio_speaker_rcv(void);
unsigned char aw87319_audio_off_rcv(void);
 ...
 ******************************************************************************/
static unsigned char aw87319_spk_reg_val(unsigned char reg)
{
...
static unsigned char aw87319_rcv_reg_val(unsigned char reg)
{
...
EXPORT_SYMBOL(aw87319_audio_receiver_rcv);
...
EXPORT_SYMBOL(aw87319_audio_speaker_rcv);
...
EXPORT_SYMBOL(aw87319_audio_off_rcv);
...
static int aw87319_hw_reset(void)
{
	pr_info("%s enter\n", __func__);
 ...
 * check chip id
 *****************************************************/
static int aw87319_read_chipid(void)
{
	unsigned int cnt = 0;
	unsigned int reg = 0;
...
static const struct of_device_id extpa_of_match[] = {
	{.compatible = "awinic,aw87319_pa_rcv"},
	{},
};
...
static int __init aw87319_pa_init(void) {
	int ret;
	printk("%s Enter init receiver\n", __func__);

	ret = i2c_add_driver(&aw87319_i2c_driver);
	printk("%s receiver i2c add driver return %d\n", __func__, ret);
	if (ret) {
		printk("****[%s] Unable to register receiver driver (%d)\n", __func__, ret);
		return ret;
	}
	return 0;
}
