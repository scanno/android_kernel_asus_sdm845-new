 ...
 * aw87319 marco
 ******************************************************************************/
#define AW87319_I2C_NAME	"AW87319_PA_SPK" 
 ...
 * aw87319 functions
 ******************************************************************************/
unsigned char aw87319_audio_receiver_spk(void);
unsigned char aw87319_audio_speaker_spk(void);
unsigned char aw87319_audio_off_spk(void);
...
EXPORT_SYMBOL(aw87319_audio_receiver_spk);
...
EXPORT_SYMBOL(aw87319_audio_speaker_spk);
...
EXPORT_SYMBOL(aw87319_audio_off_spk);
...
static const struct of_device_id extpa_of_match[] = {
	{.compatible = "awinic,aw87319_pa_spk"},
	{},
};
...
static int __init aw87319_pa_init(void) {
	int ret;
	printk("%s Enter init speaker\n", __func__);

	ret = i2c_add_driver(&aw87319_i2c_driver);
	printk("%s speaker i2c add driver return %d\n", __func__, ret);
	if (ret) {
		printk("****[%s] Unable to register speaker driver (%d)\n", __func__, ret);
		return ret;
	}
	return 0;
}
